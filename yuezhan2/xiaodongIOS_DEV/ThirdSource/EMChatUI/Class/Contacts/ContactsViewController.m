...
- (UILabel *)unapplyCountLabel
{
    if (_unapplyCountLabel == nil) {
        ...
        _unapplyCountLabel.backgroundColor = NavgationColor;
...
- (EMSearchDisplayController *)searchController
{
    if (_searchController == nil) {
        ...
        [_searchController setDidSelectRowAtIndexPathCompletion:^(UITableView *tableView, NSIndexPath *indexPath) {
            ...
            ChatViewController *chatVC = [[ChatViewController alloc] initWithChatter:buddy.username isGroup:NO WithIcon:@""];
...
- (void)reloadApplyView
{
    ...
    else
    {
        ...
        CGSize size = [tmpStr boundingRectWithSize:CGSizeMake(50, 20) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:self.unapplyCountLabel.font,NSFontAttributeName,nil] context:nil].size;
