...
@implementation WPCCustomKeyboard
@synthesize mDelegate;
static WPCCustomKeyboard *customKeyboard = nil;
...
+(WPCCustomKeyboard *)customKeyboard
{
    @synchronized(self)
    {
        ...
        {
            customKeyboard = [[WPCCustomKeyboard alloc] init];
        }
...
-(void)textViewShowView:(UIViewController *)viewController customKeyboardDelegate:(id)delegate
{
    ...
    self.mTextView =[[UITextView alloc]initWithFrame:CGRectMake(1, 1, UISCREENWIDTH-90, 28)];
